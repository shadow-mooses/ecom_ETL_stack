...
- containerized instance of airflow
- containerized instance of dbt
...
## Orchestration
Airflow to generate and write new lines of sales data every 5 minutes to the sales_order and customers tables in mysql - this is to simulate online orders coming through.
Build data transformations in dbt - this is to simulate transformations of tables for an analyst or bi tool to manipulate and dashboard for a daily/weekly business review.
...
5. run `docker compose up airflow-init` in your directory to initialize the airflow containers.
...
3. Create a user for dbt in the same fashion.
...
bugs to fix
Find compatible packages for airflow to execute commands in the docker cli.
